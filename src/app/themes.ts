...
export const themes: Record<string, ThemeColors> = {
  ...
  // bg=#3e2c23 (dark brown) — 6 permutations
  "desert-dusk":   { background: "#3e2c23", accent: "#2fa4d7", primary: "#f5e9d8", secondary: "#e76f2e" },
  "desert-night":  { background: "#3e2c23", accent: "#2fa4d7", primary: "#e76f2e", secondary: "#f5e9d8" },
  "desert-earth":  { background: "#3e2c23", accent: "#f5e9d8", primary: "#2fa4d7", secondary: "#e76f2e" },
  "desert-shadow": { background: "#3e2c23", accent: "#f5e9d8", primary: "#e76f2e", secondary: "#2fa4d7" },
  "desert-umber":  { background: "#3e2c23", accent: "#e76f2e", primary: "#2fa4d7", secondary: "#f5e9d8" },
  "desert-cave":   { background: "#3e2c23", accent: "#e76f2e", primary: "#f5e9d8", secondary: "#2fa4d7" },
  // bg=#f5e9d8 (cream) — 6 permutations
  "desert-dawn":   { background: "#f5e9d8", accent: "#2fa4d7", primary: "#3e2c23", secondary: "#e76f2e" },
  "desert-sand":   { background: "#f5e9d8", accent: "#2fa4d7", primary: "#e76f2e", secondary: "#3e2c23" },
  "desert-noon":   { background: "#f5e9d8", accent: "#3e2c23", primary: "#2fa4d7", secondary: "#e76f2e" },
  "desert-haze":   { background: "#f5e9d8", accent: "#3e2c23", primary: "#e76f2e", secondary: "#2fa4d7" },
  "desert-parch":  { background: "#f5e9d8", accent: "#e76f2e", primary: "#2fa4d7", secondary: "#3e2c23" },
  "desert-bone":   { background: "#f5e9d8", accent: "#e76f2e", primary: "#3e2c23", secondary: "#2fa4d7" },
  // bg=#2fa4d7 (sky blue) — 6 permutations
  "desert-sky":    { background: "#2fa4d7", accent: "#f5e9d8", primary: "#3e2c23", secondary: "#e76f2e" },
  "desert-rain":   { background: "#2fa4d7", accent: "#f5e9d8", primary: "#e76f2e", secondary: "#3e2c23" },
  "desert-oasis":  { background: "#2fa4d7", accent: "#3e2c23", primary: "#f5e9d8", secondary: "#e76f2e" },
  "desert-azure":  { background: "#2fa4d7", accent: "#3e2c23", primary: "#e76f2e", secondary: "#f5e9d8" },
  "desert-cool":   { background: "#2fa4d7", accent: "#e76f2e", primary: "#f5e9d8", secondary: "#3e2c23" },
  "desert-mirage": { background: "#2fa4d7", accent: "#e76f2e", primary: "#3e2c23", secondary: "#f5e9d8" },
  // bg=#e76f2e (burnt orange) — 6 permutations
  "desert-ember":  { background: "#e76f2e", accent: "#3e2c23", primary: "#f5e9d8", secondary: "#2fa4d7" },
  "desert-flame":  { background: "#e76f2e", accent: "#2fa4d7", primary: "#f5e9d8", secondary: "#3e2c23" },
  "desert-heat":   { background: "#e76f2e", accent: "#2fa4d7", primary: "#3e2c23", secondary: "#f5e9d8" },
  "desert-blaze":  { background: "#e76f2e", accent: "#f5e9d8", primary: "#2fa4d7", secondary: "#3e2c23" },
  "desert-rust":   { background: "#e76f2e", accent: "#f5e9d8", primary: "#3e2c23", secondary: "#2fa4d7" },
  "desert-glow":   { background: "#e76f2e", accent: "#3e2c23", primary: "#2fa4d7", secondary: "#f5e9d8" },
};
