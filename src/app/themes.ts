...
export const themes: Record<string, ThemeColors> = {
  ...
  "terra-mist": { background: "#bb6464", accent: "#cdb699", primary: "#c3dbd9", secondary: "#c8f2ef" },
  "ember-dune": { background: "#bb6464", accent: "#c3dbd9", primary: "#cdb699", secondary: "#c8f2ef" },
  "terra-frost": { background: "#bb6464", accent: "#c3dbd9", primary: "#c8f2ef", secondary: "#cdb699" },
  "ember-wheat": { background: "#bb6464", accent: "#c8f2ef", primary: "#cdb699", secondary: "#c3dbd9" },
  "clay-sage": { background: "#bb6464", accent: "#c8f2ef", primary: "#c3dbd9", secondary: "#cdb699" },
  "dune-sage": { background: "#cdb699", accent: "#bb6464", primary: "#c3dbd9", secondary: "#c8f2ef" },
  "dune-frost": { background: "#cdb699", accent: "#bb6464", primary: "#c8f2ef", secondary: "#c3dbd9" },
  "sand-frost": { background: "#cdb699", accent: "#c3dbd9", primary: "#c8f2ef", secondary: "#bb6464" },
  "dune-rose": { background: "#cdb699", accent: "#c8f2ef", primary: "#bb6464", secondary: "#c3dbd9" },
  "wheat-sage": { background: "#cdb699", accent: "#c8f2ef", primary: "#c3dbd9", secondary: "#bb6464" },
  "sea-wheat": { background: "#c3dbd9", accent: "#bb6464", primary: "#cdb699", secondary: "#c8f2ef" },
  "sea-frost": { background: "#c3dbd9", accent: "#bb6464", primary: "#c8f2ef", secondary: "#cdb699" },
  "mist-rose": { background: "#c3dbd9", accent: "#cdb699", primary: "#bb6464", secondary: "#c8f2ef" },
  "teal-frost": { background: "#c3dbd9", accent: "#cdb699", primary: "#c8f2ef", secondary: "#bb6464" },
  "mist-sand": { background: "#c3dbd9", accent: "#c8f2ef", primary: "#cdb699", secondary: "#bb6464" },
  "frost-wheat": { background: "#c8f2ef", accent: "#bb6464", primary: "#cdb699", secondary: "#c3dbd9" },
  "frost-sage": { background: "#c8f2ef", accent: "#bb6464", primary: "#c3dbd9", secondary: "#cdb699" },
  "ice-rose": { background: "#c8f2ef", accent: "#cdb699", primary: "#bb6464", secondary: "#c3dbd9" },
  "mint-teal": { background: "#c8f2ef", accent: "#cdb699", primary: "#c3dbd9", secondary: "#bb6464" },
  "aqua-sand": { background: "#c8f2ef", accent: "#c3dbd9", primary: "#cdb699", secondary: "#bb6464" },
};
